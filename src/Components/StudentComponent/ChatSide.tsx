...
function ChatSide({ chatId }: { chatId: string }) {
  ...
  onClick={() => navigate(-1)}
  type="button"
  className="flex items-center justify-center w-full px-4 py-2 text-sm text-gray-700 transition-colors duration-200 bg-blue-500 border rounded-lg gap-x-2 sm:w-auto sm:px-5 sm:py-2 dark:hover:bg-gray-800 dark:bg-gray-900 hover:bg-gray-100 dark:text-gray-200 dark:border-gray-700"
>
  <svg
