...
import changePasswordSchema from "../../Validations/Student/changePassword"
...
const ChangePassword: React.FC = () => {
    ...
    const formik = useFormik({
        ...
        onSubmit: ({ currentPassword, newPassword}) => {
            studentAPi.changePassword(student.student.email as string, currentPassword, newPassword).then((res) => {
    ...
    return (
        <div className="p-4 sm:ml-64 bg-white min-h-screen">
            <div className="p-4 rounded-lg dark:border-gray-700">
                <div className="flex  mb-4 rounded-lg bg-gray-5 shadow-md">
                    <div className="flex  py-10">
                        <form className="max-w-2xl" onSubmit={formik.handleSubmit}>
                            <div className="flex flex-wrap px-10">
                                <h2 className="text-xl font-Poppins text-gray-600 dark:text-gray-300 ">Change Password:</h2>

                                <div className="flex flex-col gap-2 w-full border-gray-400">

                                    <div>
                                        <label className="text-gray-600 dark:text-gray-400">old password</label>
                                        <input
