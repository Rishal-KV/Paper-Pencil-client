    ...
    <div className="dropdown dropdown-end">
      ...
      <div tabIndex={0} className="mt-3 z-50 card card-compact dropdown-content w-52 bg-base-100 shadow">
        <div className="card-body">
          <Link to="/instructor/" className="btn  btn-ghost font-Poppins">Dashboard</Link>
          <Link to="/instructor/courses" className="btn btn-ghost font-Poppins">Courses</Link>
          <Link to="/instructor/chats" className="btn btn-ghost font-Poppins">Chats</Link>
          <Link to="/instructor/questions" className="btn btn-ghost font-Poppins">Questions</Link>
          <Link to="/instructor/profile" className="btn btn-ghost font-Poppins">Profile</Link>
          <Link to="/instructor/editprofile" className="btn btn-ghost font-Poppins">profile Settings</Link>
